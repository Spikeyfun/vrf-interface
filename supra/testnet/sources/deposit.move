module supra_addr::deposit {
    ...
    #[deprecated]
    #[view]
    native public fun get_client_contracts_object_address(): address;

    #[deprecated]
    #[view]
    native public fun get_contract_owner_address(_contract: address): address;

    #[deprecated]
    #[view]
    native public fun is_contract_eligible(client_address: address, contract_address: address): bool;

    #[deprecated]
    #[view]
    native public fun is_client_whitelisted(client_address: address): bool;

    #[deprecated]
    #[view]
    native public fun has_minimum_balance_reached(client_address: address): bool;

    #[deprecated]
    #[view]
    native public fun check_min_balance(client_address: address): u64;

    #[deprecated]
    #[view]
    native public fun check_min_balance_supra(): u64;

    #[deprecated]
    #[view]
    native public fun check_min_balance_client(client_address: address): u64;

    #[deprecated]
    #[view]
    native public fun check_effective_balance(client_address: address): u64;

    #[deprecated]
    #[view]
    native public fun get_clients_contract(client_address: address): vector<address>;

    #[deprecated]
    #[view]
    native public fun get_subscription_by_client(client_address: address): SubscriptionPeriod;

    #[deprecated]
    #[view]
    native public fun get_balance_of_client(addresses: vector<address>): vector<ClientBalanceInfo>;
}
